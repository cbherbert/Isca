...
exp_name = 'superrotation_nzforcing_q1'
exp = Experiment(exp_name, codebase=cb)

#Tell model how to write diagnostics
diag = DiagTable()
diag.add_file('atmos_monthly', 90, 'days', time_units='days')
...
diag.add_field('hs_forcing', 'q_eqf', time_avg=True)
...
namelist = Namelist({
    ...
    'atf_forcing_nml': {
        'q0atf': 1.0 # Amplitude of the non-zonal heating term
    },
